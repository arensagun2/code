...
superInterfaces = new ArrayList<TypeName>();
        interfaces = qualifiedIdentifier();
superInterfaces.add(interfaces);
        label_5:
        while (true) {
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case COMMA:{
...
{if ("" != null) return statement;}
  ...
  final private JStatement statement() throws ParseException {int line = 0;
    ...
    // Exception handlers - p4.13
    JBlock tryBlock = null;
    JFormalParameter param = null;
    ArrayList<JFormalParameter> paramArr = new ArrayList<JFormalParameter>();
    JBlock catchBlock = null;
    ArrayList<JBlock> catchArr = new ArrayList<JBlock>();
...
statement = new JForStatement(line, init, expr, update, consequent);
        break;
        }
      case IF:{
        jj_consume_token(IF);
...
statement = new JTryStatement(line, tryBlock, paramArr, catchArr, finallyBlock);
        break;
        }
      case WHILE:{
        jj_consume_token(WHILE);
...
init.add(statement);
        ...
        while (true) {
          ...
          jj_consume_token(COMMA);
          statement2 = statementExpression();
init.add(statement2);
        }
      } else {
        switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
{if ("" != null) return init;}
  ...
  final private ArrayList<JStatement> forUpdate() throws ParseException {ArrayList<JStatement> update = new ArrayList<JStatement>();
    JStatement statement = null;
    JStatement statement2 = null;
    try {
      statement = statementExpression();
...
{if ("" != null) return update;}
  ...
  final private SwitchStatementGroup switchBlockStatementGroup() throws ParseException {SwitchStatementGroup stmtGroup = null;
...
{if ("" != null) return new SwitchStatementGroup(switchLabels, block);}
    throw new Error("Missing return statement in function");
}

  final private JExpression switchLabel() throws ParseException {JExpression switchLabel = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case CASE:{
...
{if ("" != null) return lhs;}
  ...
  final private JExpression conditionalExpression() throws ParseException {int line = 0;
    JExpression lhs = null, rhs = null, expr = null;
    try {
...
lhs = new JConditionalExpression(line, lhs, expr, rhs);
        break;
        }
      default:
        jj_la1[56] = jj_gen;
...
{if ("" != null) return expr;}
 ...
 {
    if (jj_scan_token(LRS)) return true;
 ...
 {
    if (jj_scan_token(LRS_ASSIGN)) return true;
    if (jj_3R_56()) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ARS_ASSIGN)) return true;
    if (jj_3R_56()) return true;
    return false;
  }
 ...
 {
    if (jj_scan_token(ALS_ASSIGN)) return true;
    if (jj_3R_56()) return true;
    return false;
  }
  ...
  private boolean jj_3R_153()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x0,0x40000000,0x41000,0x40000,0x1000,0x1000,0x1000000,0x0,0x20000000,0x0,0x1000000,0x423000,0x423000,0x0,0x0,0x422000,0x0,0x0,0x0,0x422000,0x422000,0x0,0x0,0x422000,0x1a6a6000,0x1a284000,0x2422000,0x2000000,0x2000000,0x2000000,0x108000,0x10000,0x4000000,0x1a284000,0x0,0x422000,0x0,0x422000,0x0,0x108000,0x1a6a6000,0x108000,0x0,0x0,0x2000000,0x0,0x2000000,0x0,0x2000000,0x422000,0x422000,0x0,0x0,0x422000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x0,0x2000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2000000,0x422000,0x0,0x0,0x0,0x2000000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x20,0x0,0x5c2,0x2,0x5c0,0x5c0,0x0,0x100000,0x0,0x100000,0x0,0x405c5,0x405c5,0x100000,0x8000,0x40005,0x100000,0x8000,0x10800000,0x5,0x40005,0x100000,0x8000,0x5,0x118b7a1d,0x118b7a18,0x101281d,0x1012818,0x1012818,0x1012818,0x0,0x0,0x0,0x118b7a18,0x100000,0x5,0x100000,0x5,0x100000,0x0,0x118b7a1d,0x0,0x100000,0x0,0x1812818,0x100000,0x1812818,0x100000,0x1012818,0x5,0x5,0x400000,0x400000,0x5,0x40000000,0x40000000,0x0,0x0,0x0,0x0,0x0,0x80000000,0x0,0x0,0x0,0x0,0x20000000,0x20000000,0x0,0x0,0x0,0x0,0x1012818,0x0,0x1012818,0x600000,0x0,0x0,0x1000000,0x600000,0x1000000,0x1000000,0x1200000,0x1000000,0x1012818,0x5,0x800000,0x1000000,0x400000,0x10010,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x2284820,0x2284820,0x2284820,0x2284820,0x2284820,0x2284820,0x0,0x0,0x0,0x2284820,0x0,0x0,0x0,0x0,0x0,0x0,0x2284820,0x0,0x0,0x8,0x2284820,0x0,0x2284820,0x0,0x2284820,0x0,0x0,0x0,0x0,0x0,0xa512008d,0xa512008d,0x8000000,0x8000,0x1000,0x800000,0x0,0x0,0x400100,0x400100,0x42600,0x42600,0x10002,0x10002,0x2080000,0x2080000,0x50000040,0x50000040,0x2284820,0x204000,0x0,0x0,0x820,0x820,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x4,0x0,0x0,0x0,0x4,0x4,0x0,0x0,0x4,0x1cc4,0x1cc4,0x1cc4,0x1cc4,0x1cc4,0x1cc4,0x0,0x0,0x0,0x1cc4,0x0,0x4,0x0,0x4,0x0,0x0,0x1cc4,0x0,0x0,0x0,0x1cc4,0x0,0x1cc4,0x0,0x1cc4,0x0,0x0,0x0,0x0,0x4,0x2,0x2,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1cc4,0x0,0x1cc4,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1cc4,0x4,0x0,0x0,0x0,0x1cc0,};
	}
